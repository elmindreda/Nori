...
void btDiscreteDynamicsWorld::clearForces()
{
    ...
    for (int i = 0;  i < m_nonStaticRigidBodies.size();  i++)
    {
        ...
        //it might break backward compatibility (people applying forces on
        //sleeping objects get never cleared and accumulate on wake-up
        body->clearForces();
    }
}
...
void btDiscreteDynamicsWorld::integrateTransforms(btScalar timeStep)
{
	...
	if (body->isActive() && (!body->isStaticOrKinematicObject()))
	{
		...
		if (body->getCollisionShape()->isConvex())
		{
			...
			StaticOnlyCallback(btCollisionObject* me,
		    ...
		    sweepResults.m_allowedPenetration = getDispatchInfo().m_allowedCcdPenetration;
                    ...
                    if (sweepResults.hasHit() && (sweepResults.m_closestHitFraction < 1.f))
                    {
                        ...
                        btScalar depth = 0.f;
                        appliedImpulse = resolveSingleCollision(body,
