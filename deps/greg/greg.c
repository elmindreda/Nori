...
int GREG_ARB_debug_output;
int GREG_ARB_half_float_pixel;
...
PFNGLDEBUGMESSAGECALLBACKARBPROC greg_glDebugMessageCallbackARB;
PFNGLDEBUGMESSAGECONTROLARBPROC greg_glDebugMessageControlARB;
PFNGLDEBUGMESSAGEINSERTARBPROC greg_glDebugMessageInsertARB;
...
PFNGLGETDEBUGMESSAGELOGARBPROC greg_glGetDebugMessageLogARB;
...
int gregInit(void)
{
  ...
  greg_glDebugMessageCallbackARB = (PFNGLDEBUGMESSAGECALLBACKARBPROC) gregGetProcAddress("glDebugMessageCallbackARB");
  greg_glDebugMessageControlARB = (PFNGLDEBUGMESSAGECONTROLARBPROC) gregGetProcAddress("glDebugMessageControlARB");
  greg_glDebugMessageInsertARB = (PFNGLDEBUGMESSAGEINSERTARBPROC) gregGetProcAddress("glDebugMessageInsertARB");
  ...
  greg_glGetDebugMessageLogARB = (PFNGLGETDEBUGMESSAGELOGARBPROC) gregGetProcAddress("glGetDebugMessageLogARB");
  ...
  GREG_ARB_debug_output = gregExtensionSupported("GL_ARB_debug_output");
  GREG_ARB_half_float_pixel = gregExtensionSupported("GL_ARB_half_float_pixel");
