...
public:
   ...
   */
  inline void emit(std::list<R>& results) const;
  /*! Assignment operator.
   *  @note This does not copy any existing connections to the source object.
   */
...
template <typename R>
inline void Signal0<R>::emit(std::list<R>& results) const
{
  results.clear();
  for (typename SlotList::const_iterator i = slots.begin();  i != slots.end();  i++)
...
public:
  ...
  /*! Calls the targets for all slots in this signal and stores the return values.
   */
  inline void emit(std::list<R>& results, A1 a1) const;
  /*! Assignment operator.
   *  @note This does not copy any existing connections to the source object.
   */
...
template <typename R, typename A1>
inline void Signal1<R,A1>::emit(std::list<R>& results, A1 a1) const
{
  results.clear();
  for (typename SlotList::const_iterator i = slots.begin();  i != slots.end();  i++)
...
public:
  ...
  /*! Calls the targets for all slots in this signal and stores the return values.
   */
  inline void emit(std::list<R>& results, A1 a1, A2 a2) const;
  /*! Assignment operator.
   *  @note This does not copy any existing connections to the source object.
   */
...
template <typename R, typename A1, typename A2>
inline void Signal2<R,A1,A2>::emit(std::list<R>& results, A1 a1, A2 a2) const
{
  results.clear();
  for (typename SlotList::const_iterator i = slots.begin();  i != slots.end();  i++)
...
public:
  ...
  /*! Calls the targets for all slots in this signal and stores the return values.
   */
  inline void emit(std::list<R>& results, A1 a1, A2 a2, A3 a3) const;
  /*! Assignment operator.
   *  @note This does not copy any existing connections to the source object.
   */
...
template <typename R, typename A1, typename A2, typename A3>
inline void Signal3<R,A1,A2,A3>::emit(std::list<R>& results, A1 a1, A2 a2, A3 a3) const
{
  results.clear();
  for (typename SlotList::const_iterator i = slots.begin();  i != slots.end();  i++)
...
public:
  ...
  /*! Calls the targets for all slots in this signal and stores the return values.
   */
  inline void emit(std::list<R>& results, A1 a1, A2 a2, A3 a3, A4 a4) const;
  /*! Assignment operator.
   *  @note This does not copy any existing connections to the source object.
   */
...
template <typename R, typename A1, typename A2, typename A3, typename A4>
inline void Signal4<R,A1,A2,A3,A4>::emit(std::list<R>& results, A1 a1, A2 a2, A3 a3, A4 a4) const
{
  results.clear();
  for (typename SlotList::const_iterator i = slots.begin();  i != slots.end();  i++)
