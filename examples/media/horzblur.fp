...
float4 main(in float2 mapping, uniform sampler2D image) : COLOR
{
  ...
  gaussFilter[0] = float4(0.0, -3.0, 0.0,  5.0 / 54.0);
  gaussFilter[1] = float4(0.0, -2.0, 0.0,  7.0 / 54.0);
  gaussFilter[2] = float4(0.0, -1.0, 0.0, 10.0 / 54.0);
  gaussFilter[3] = float4(0.0,  0.0, 0.0, 15.0 / 54.0);
  gaussFilter[4] = float4(0.0,  1.0, 0.0, 10.0 / 54.0);
  gaussFilter[5] = float4(0.0,  2.0, 0.0,  7.0 / 54.0);
  gaussFilter[6] = float4(0.0,  3.0, 0.0,  5.0 / 64.0);
